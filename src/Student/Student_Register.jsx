...
function Student_Register() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const { name, email, password, cpassword, phone, address } = formData;
    ...
    <div className="h-screen flex flex-col md:flex-row overflow-hidden">
      ...
      <div className="md:w-1/2 w-full flex items-center justify-center bg-gray-200">
        <form onSubmit={handleSubmit} className="w-full max-w-md bg-white p-6 rounded-xl shadow-lg">
          <h2 className="text-xl font-bold text-center text-gray-800 mb-4">Register as Student</h2>
          ...
          <div className="space-y-3">
            {[
              ...
              { label: 'Address', name: 'address', type: 'text', placeholder: 'Kolkata' },
            ].map((field, idx) => (
              <div key={idx}>

  ...
  useEffect(() => {
    ...
    if (userData) {
      ...
      const withDefaults = {
        ...
        email: parsed.email || "",
        phone: parsed.phone || "",
        designation: parsed.designation || "Library Manager",
      };

      setLibrarian(withDefaults);  
    ...
    <div className="min-h-screen bg-gray-100 p-6 font-sans">
      ...
      <div className="max-w-md mx-auto bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        <div className="bg-indigo-100 py-8 px-6 text-center">
          <div className="w-24 h-24 mx-auto rounded-full bg-indigo-500 text-white text-5xl flex items-center justify-center shadow-md">
            📚
          </div>
          ...
          <p className="text-gray-700">
            {librarian.designation || "Library Manager"}
          </p>
        ...
        <div className="px-6 py-6 space-y-4 text-gray-700">
          ...
          <div>
            <span className="font-medium">Full Name:</span> {librarian.name}
          </div>
          <div>
            <span className="font-medium">Email:</span> {librarian.email}
          </div>
          <div>
